    ...
    <main className="word-shell min-h-screen px-5 py-8">
      <section className="mx-auto max-w-3xl">
        ...
        <div className="word-card p-6 sm:p-8">
          <div className="rounded-2xl bg-cyan-50 p-4 text-sm leading-6 text-cyan-950"><strong>练习步骤：</strong>先听词典标准发音 → 点击录音并手动结束 → 回听自己的录音 → 自评 → 查看系统反馈。<span className="mt-1 block">建议使用 Chrome 或 Edge；如果学习通内无法自动识别，请点右上角“在浏览器打开”。录音仍可正常上传给老师回听。</span>{unit.note && <span className="block mt-1">老师提示：{unit.note}</span>}</div>
